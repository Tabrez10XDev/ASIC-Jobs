...
const ApplyJobDetails = (props) => {
    ...
    const onoknutton = () => {
        if (okbutton === 1) navigation.navigate(RouteName.JOB_DETAILS_SCREEN);
        if (okbutton === 2) navigation.navigate(RouteName.HOME_TAB);
    }
    ...
    return (
        <View style={ResumeStyle.minstyleviewphotograpgy}>
            <ScrollView
