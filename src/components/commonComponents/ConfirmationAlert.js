                ...
                <View style={Style.ModalView}>
                    {iconVisible &&
                        <View style={Style.setroundcenter}>
                            <View style={[Style.checkiconright,{borderColor:Colors.theme_background_brink_pink}]}>
                                <IconF style={Style.setbackgroundicon} color={Colors.theme_background_brink_pink} name="check" size={45} />
                            </View>
                        </View>
                    }
